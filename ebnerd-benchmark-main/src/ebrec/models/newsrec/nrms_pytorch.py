...
class NewsEncoder(nn.Module):
    ...
    def __init__(self, embedding_dim, vocab_size, pretrained_embedding=None, dropout=0.2, head_num=8, head_dim=64, attn_hidden_dim=768, seed=None):
        super().__init__()
        torch.manual_seed(seed)
...
class UserEncoder(nn.Module):
    ...
    def __init__(self, news_encoder, history_size, head_num=8, head_dim=64, attn_hidden_dim=768, seed=None):
        super().__init__()
        torch.manual_seed(seed)
